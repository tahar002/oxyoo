                			...
                			<div class="row">
                				...
                				<div class="col-md-12">
                					...
                					<div class="card card-body">
                						...
                						<h3 class="card-title mt-0">Terms and Conditions</h3>

                						<hr>

                						<div class="summernote" id="summernote"><?php echo $TermsAndConditions; ?></div>
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <input type="text" id="webview_url" name="webview_url"
                                                            ...
                                                            value="<?php echo base_url(); ?>terms_and_conditions/webview" disabled="">
                                                        <span class="input-group-text waves-effect waves-light"
                                                            id="option-date"
                                                            onclick="copyToClipboard('webview_url')">Copy</span>
                                                        <a class="btn btn-primary" id="gsk" href="<?php echo base_url(); ?>terms_and_conditions/webview" target="_blank">
                                                            View</a>
                                                    </div>
                                                </div>
                                            </div>
