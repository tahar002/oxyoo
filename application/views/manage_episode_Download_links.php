                        		...
                        		<div class="card card-body">
                        			...
                        			<div class="panel-body">
                        				...
                        				<div class="form-group mb-3"> <label class="control-label">Download type</label>
                        					<select id="download_type" class="form-control form-select" name="source"
                        						id="selected-source">
                        				...
                        				<div class="form-group mb-3"> <label class="control-label">Status</label> <select
                        						id="Status" class="form-control form-select" name="source" id="selected-source">
									...
									<div class="modal-body">
										<div class="panel-body">
											...
											<div class="form-group mb-3"> <label class="control-label">Name</label>&nbsp;&nbsp;<input
													id="modal_Label" type="text" name="label" class="form-control" placeholder="Name#1"
													required=""> </div>

											<div class="form-group mb-3"> <label class="control-label">Order</label> <input id="modal_Order"
													type="number" name="order" class="form-control" placeholder="0 to 9999" required="">
											</div>

											<div class="form-group mb-3"> <label class="control-label">Quality</label>&nbsp;&nbsp;<input
													id="modal_Quality" type="text" name="label" class="form-control" placeholder="1080p"
													required=""> </div>

											<div class="form-group mb-3"> <label class="control-label">Size</label>&nbsp;&nbsp;<input
													id="modal_Size" type="text" name="label" class="form-control" placeholder="1.0GB"
													required=""> </div>
											...
											<div class="form-group mb-3"> <label class="control-label">Download type</label> <select
													id="modal_download_type" class="form-control form-select" name="modal_download_type"
													id="selected-source">
													<option value="Internal" selected="">Internal</option>
													<option value="External">External</option>
												</select></div>

											<div class="form-group mb-3"> <label class="control-label">Status</label> <select id="modal_Status"
