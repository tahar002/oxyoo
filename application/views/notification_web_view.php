            			...
            			<div class="row align-items-center">
            				...
            				<div class="col-sm-6">
            					...
            					<div class="page-title-box">
            						...
            						<h4 class="font-size-18">Web View</h4>
            						...
            						<ol class="breadcrumb mb-0">
            							...
            							<li class="breadcrumb-item active">Web View</li>
                        	...
                        	<div class="row">
                        		<div class="col-md-12">
                        			<div class="card card-body">
                        				<h3 class="card-title mt-0">SEND PUSH NOTIFICATION (Web View)</h3>
                        				<hr>
