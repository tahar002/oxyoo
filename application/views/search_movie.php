                        	...
                        	<div class="row">
                        		...
                        		<div class="col-md-12">
                        			...
                        			<div class="card card-body">
                        				...
                        				<h3 class="card-title mt-0">Search Movies (<a
            ...
            Swal.fire({
                ...
                didOpen: ()=>{
                    ...
                    if (keyword != '') {
                        $.ajax({
                            type: 'GET',
                            url: "https://cloud.team-dooo.com/Dooo/TMDB/index.php?code="+ "<?php echo $config->license_code ?>" +"&filter=search&type=movie&query="+ keyword +"&language=" + "<?php echo $config->tmdb_language ?>",
                            dataType: 'json',
