...
class Admin extends CI_Controller {
	...
	public function android_setting() {
		...
		if($this->input->post('androidSetting')) {
			...
			if($this->Admin_model->androidSetting($this->input->post('apk_name'), $this->input->post('package_name'), $login_mandatory_bool, $maintenance_bool, $this->input->post('All_Live_TV_Type'), $this->input->post('All_Movies_Type'), $this->input->post('All_Series_Type'), $LiveTV_Visiable_in_Home_bool, $genreList_Visiable_in_Home_bool, $this->input->post('primeryThemeColor'), $blocked_regions, $onboarding_status)) {
